...
export default function ShiftsScreen() {
  ...
  const save = async () => {
    if (!name.trim() || !start.trim() || !end.trim()) { setModalError('Name, start time, and end time are required.'); return; }
    ...
    try {
      const payload = { name: name.trim(), start_time: start.trim(), end_time: end.trim(), grace_period_minutes: graceParsed };
  ...
  return (
    <View style={s.screen}>
      ...
      {loading ? (
        ...
        <View style={s.empty}><Text style={s.emptyIcon}>🕐</Text><Text style={s.emptyTitle}>No shifts yet</Text></View>
      ) : (
          ...
          <View style={m.sheet}>
            ...
            <View style={m.timeRow}>
              <View style={m.timeField}>
                ...
                <TextInput style={m.input} value={start} onChangeText={setStart} placeholder="HH:MM" placeholderTextColor={colors.mutedLight} />
              </View>
              <View style={m.timeField}>
                <Text style={m.label}>End time</Text>
                <TextInput style={m.input} value={end} onChangeText={setEnd} placeholder="HH:MM" placeholderTextColor={colors.mutedLight} />
              </View>
            </View>

  ...
  return (
    <View style={s.screen}>
      ...
      <FlatList
        ...
        ListEmptyComponent={
          loading ? null : (
            <View style={s.empty}><Ionicons name="calendar-outline" size={40} color={colors.muted} /><Text style={s.emptyTitle}>No holidays defined</Text></View>
          )
        }
        renderItem={({ item }) => (
          <View style={s.card}>
            <View style={s.cardTop}>
              <View style={s.iconWrap}><Ionicons name="calendar-outline" size={22} color={colors.brand} /></View>
...
const s = StyleSheet.create({
  ...
  dateBadgeText: { fontSize: typography.xs, fontFamily: 'Inter_700Bold', color: colors.brand },
